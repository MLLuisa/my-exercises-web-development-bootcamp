  ...
  return (
    <div>
      <form className="form" onSubmit={handleForm}>
        ...
        <div className="form">
          {/* name */}
          <InputGroupText  htmlFor={"name"} text={"nombre"} name={"name"} id={"name"} placeholder={"nombre"} value={name} handleName={handleName}/>
       ...
       <Preview formProps={{name,email,region,paymentType,legalTerms}}/>
